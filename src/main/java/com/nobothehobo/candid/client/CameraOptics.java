...
public final class CameraOptics {
    ...
    public static Vec3 anchor(){var p=Minecraft.getInstance().player;if(p==null)return Vec3.ZERO;var pos=CameraData.tripod(camera(),p);return pos==null?p.getEyePosition():new Vec3(pos.getX()+.5,pos.getY()+1.62,pos.getZ()+.5).add(p.getLookAngle().scale(.28));}
